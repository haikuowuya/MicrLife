 ...
 */
public class FastScrollerLinearLayout   extends LinearLayout
{
    ...
    public FastScrollerLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialise(context);
    }

    public FastScrollerLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setRecyclerViewPosition(float y) {
        if (recyclerView != null) {
            ...
            handle.setText(  cityAdapter.getHeaderText(targetPos));
        }
    }
